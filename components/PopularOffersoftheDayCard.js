...
const StoreCard = (props, productDetailsData) => {
  ...
  const imageUrl = `https://ik.imagekit.io/tlp/tr:h-400,q-70/store/20180522154/assets/items/largeimages/${code}.jpg?ik-sdk-version=java-1.0.3`;
          ...
          <div className="flex justify-center items-start items-startb">
            <div className="flex w-full justify-center items-center flex-col content-wrapper">
              ...
              <div className="w-full image-wrapper popularImage">
                <img
                  src={`https://ik.imagekit.io/ofb/starter/tr:h-400,q-70/store/20180522154/assets/items/largeimages/${code}.jpg`}
                  alt={desc}
